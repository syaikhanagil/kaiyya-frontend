...
const NewRelease = () => {
    ...
    useEffect(() => {
        API.fetchProductNewRelease().then((res: any) => {
    ...
    return (
        <>
            <Helmet>
                <title>New Release | Kaiyya Dress</title>
            </Helmet>
            <Main useHeader paddingTop backTo="/" title="New Release" searchBtn>
                <>
                    <NewReleaseWrapper>
...
export default connect(mapStateToProps)(NewRelease);
