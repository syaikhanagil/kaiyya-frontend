...
const PermataContent = (props: any) => {
    ...
    return (
        <>
            ...
            {tabActive === 'atm' && (
                <>
                    <Text block bold marginY>LANGKAH 1: MASUK KE AKUN ANDA</Text>
                    <Text block extraSmall>1. Masukkan kartu ATM Permata anda</Text>
                    <Text block extraSmall>2. Masukkan PIN</Text>
                    <Text block bold marginY>LANGKAH 2: DETAIL PEMBAYARAN</Text>
                    <Text block extraSmall>1. Pilih menu &quot;Transaksi Lainnya&quot;</Text>
                    <Text block extraSmall>2. Pilih menu &quot;Pembayaran&quot;</Text>
                    <Text block extraSmall>3. Pilih menu &quot;Pembayaran Lainnya&quot;</Text>
